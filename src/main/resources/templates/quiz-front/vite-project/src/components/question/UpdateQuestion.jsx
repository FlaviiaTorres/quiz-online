...
const UpdateQuestion = () => {S
	...
	return (
		<div className="container">
			...
			Atualizar pergunta do quiz
			</h4>
			<div className="col-8">
				<form onSubmit={handleUpdate}>
					<div className="form-group">
						<label className="text-info">Pergunta:</label>
						<textarea
					...
					<div className="form-group">
						<label className="text-info">Alternativas:</label>
					...
					<div className="form-group">
						<label className="text-info">Resposta correta(s):</label>
						<input
							type="text"
							className="form-control mb-4"
